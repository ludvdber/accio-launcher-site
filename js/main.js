...
(function () {
  ...
  var i18n = {
    en: {
      ...
      community_sub: 'Accio Launcher is shaped by the people who play it. Your bug reports get things fixed, and your screenshots show others what it can do.',
    ...
    es: {
      ...
      games_heading: 'Los juegos', games_sub: '2001 – 2011. Diez años de Harry Potter en PC, todos en un mismo launcher. Los ocho juegos ya están disponibles.', games_cta: 'Descargar Accio Launcher',
      ...
      pf1: 'Descargas con un clic que se reanudan si se corta la conexión',
      ...
      community_sub: 'Accio Launcher mejora gracias a la gente que juega con él. Si reportas un error, ayudas a arreglarlo; si compartes una captura, ayudas a que otros lo descubran.',
      ccard1_t: 'Reporta un error',
      ccard1_d: '¿Un juego que no arranca, una descarga que se queda atascada o algo que se ve raro? Avísalo en GitHub. Es la forma más rápida de que se solucione, y así nadie más se encuentra con el mismo problema.',
      ccard1_cta: 'Abrir un reporte',
      ccard2_t: 'Comparte tus capturas',
      ccard2_d: 'Un pasillo de Hogwarts con la luz perfecta, un duelo en el momento justo, el castillo al atardecer: muéstralas en Discord o en GitHub. Las mejores serán destacadas.',
      ccard3_t: 'Propón una idea',
      ccard3_d: '¿Falta alguna función o hay algo que te molesta? Cuéntalo. El launcher está en español, francés e inglés, y para añadir un idioma no hace falta programar: basta con un archivo de traducción.',
      ...
      faq2_q: '¿Es gratis?', faq2_a: 'Sí, totalmente. Es de código abierto, sin anuncios y sin rastreo.',
      faq3_q: '¿Es seguro?', faq3_a: 'El código es público en GitHub. Cada descarga se comprueba mientras llega: si un archivo se daña o se modifica por el camino, se descarta. No hace falta cuenta, no se recoge ningún dato y no hay anuncios.',
      ...
      faq7_q: '¿Tengo que reinstalarlo con cada actualización?', faq7_a: 'No. El launcher se actualiza solo con un clic, y tus juegos instalados no se tocan.',
